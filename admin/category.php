<?php
        ...
        $query = mysqli_query($conn, "select * from category inner join Main_Category ON Main_Category.id = category.main_cat_id");

        $main_query = "select * from Main_Category";
        $run = mysqli_query($conn, $main_query);
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal"
                                        data-target="#cat_model" data-whatever="@mdo">
                                    Add new Category
                                </button>
...
<div class="modal fade" id="cat_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Select Main Category</label>
                        <select name="cat" id="" class="form-control">
                            <option value="null">Select Mian Category</option>
                            <?php while($record = mysqli_fetch_array($run)){?>
