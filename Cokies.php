...
<body>
    ...
    <div class="container-fluid HelpingPage">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-12">
                ...
                <div><small><a href="index.php">Home > </a></small><small><a href="clothing.php">Assistance
                            ></a></small>
                    <small><a href="clothing.php">Cokies</a></small>
                </div>
        ...
        <div class="row ">
            <div class="col-lg-1"></div>
            <div class="col-lg-10 col-md-10 col-sm-12 text-secton Privacy">
                <div class="label">
                    <h2 style="color: rgb(117, 116, 116);">Terms and Conditions</h2>
                    <h2 style="color: rgb(117, 116, 116);">Welcome to aroma tazeen!</h2>
                </div>
                <p>
                    These terms and conditions outline the rules and regulations for the use of Aroma Tazeen's Website,
                    located at aromatazeen.com. <br>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    aroma tazeen if you do not agree to take all of the terms and conditions stated on this page. <br>
                ...
                <h4 style="color: rgb(117, 116, 116);">
                    Cookies
                </h4>
                <p>
                    We employ the use of cookies. By accessing aroma tazeen, you agreed to use cookies in agreement with
                    the Aroma Tazeen's Privacy Policy. <br>
                ...
                <p>
                    Unless otherwise stated, Aroma Tazeen and/or its licensors own the intellectual property rights for
                    all material on aroma tazeen. All intellectual property rights are reserved. You may access this
                    from aroma tazeen for your own personal use subjected to restrictions set in these terms and
                    conditions. <br>
                    You must not: <br>
                    • Republish material from aroma tazeen
                    • Sell, rent or sub-license material from aroma tazeen
                    • Reproduce, duplicate or copy material from aroma tazeen
                    • Redistribute content from aroma tazeen
                    This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help
                    of the <a href="">Terms And Conditions Generator</a> and the <a href="">Privacy Policy
                        Generator</a>.
                    Parts of this website offer an opportunity for users to post and exchange opinions and information
                    in certain areas of the website. Aroma Tazeen does not filter, edit, publish or review Comments
                    prior to their presence on the website. Comments do not reflect the views and opinions of Aroma
                    Tazeen,its agents and/or affiliates. Comments reflect the views and opinions of the person who post
                    their views and opinions. To the extent permitted by applicable laws, Aroma Tazeen shall not be
                    liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result
                    of any use of and/or posting of and/or appearance of the Comments on this website. <br>
                    Aroma Tazeen reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    You hereby grant Aroma Tazeen a non-exclusive license to use, reproduce, edit and authorize others
                    ...
                    malls, and charity fundraising groups which may not hyperlink to our Web site.<br>
                    ...
                    the context of the linking party’s site. <br>
                    ...
                    compensates the absence of Aroma Tazeen; and (d) the link is in the context of general resource
                    information. <br>
                    ...
                    products or services; and (c) fits within the context of the linking party’s site. <br>
                    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Aroma Tazeen. Please include your name, your
                    ...
                    to link. Wait 2-3 weeks for a response. <br>
                    ...
                    No use of Aroma Tazeen's logo or other artwork will be allowed for linking absent a trademark
